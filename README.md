...
**مرحباً، أنا عبد الباسط!**
أنا طالب ملتزم في مجال **C++**. تركز رحلتي على إتقان هذه اللغة القوية واستكشاف قدراتها الواسعة في تطوير البرمجيات وحل المشكلات وبناء مشاريع قوية من الألف إلى الياء. هذا الملف الشخصي هو سجل لتقدمي والمشاريع التي أبنيها على طول الطريق.
...
| :--- | :--- |
| `clsBankClient.h` | [Code](https://github.com/abdallbaset/Problem-Solving/blob/main/OOP_Bank_Project/Core/clsBankClient.h) |
